    ...
    <Modal open onClose={onClose} wide>
      <div className="p-6">
        ...
        <div className="mb-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border-2 border-grape-200 bg-white p-4"><p className="text-xs font-bold text-grape-500">الحفظ التراكمي</p><p className="mt-1 font-display text-2xl font-extrabold text-grape-700">{ar(analysis.cumulativeMemorizationPages)}</p><p className="text-xs font-bold text-grape-400">صفحة حسب السجلات المتاحة</p></div>
          <div className="rounded-2xl border-2 border-gold-400/50 bg-gold-50 p-4"><p className="text-xs font-bold text-gold-600">المراجعة التراكمية</p><p className="mt-1 font-display text-2xl font-extrabold text-gold-700">{ar(analysis.cumulativeReviewPages)}</p><p className="text-xs font-bold text-gold-600/70">صفحة حسب السجلات المتاحة</p></div>
        </div>
