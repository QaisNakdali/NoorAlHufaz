...
const SLIDES = [
  ...
  { icon: "🪙", title: "كيف يحصل الطالب على العملات؟", body: "يجمع الطالب العملات من أعماله المسجلة فعليًا خلال الحلقة، ثم يستخدمها في المتجر.", points: ["الحضور", "تسميع الحفظ والمراجعة", "السلوك والرحلات والجوائز"] },
  { icon: "🏆", title: "أبطال الأسبوع", body: "يستحقها كل من أكمل جميع أيام الحضور وسمّع الحفظ والمراجعة وحافظ على قلوبه، وحضر الرحلة إن وُجدت.", points: ["الشروط واضحة للجميع", "كل المستوفين أبطال متساوون", "لا يوجد أول أو ثانٍ أو ثالث"] },
  ...
  { icon: "🎒", title: "الرحلات", body: "عند وجود رحلة تُسجّل مشاركة الطلاب لتشجيع الالتزام والتجربة الجماعية الإيجابية.", points: ["مشاركة ممتعة", "تعزيز روح الجماعة", "تُحتسب ضمن شروط الأسبوع عند وجودها"] },
